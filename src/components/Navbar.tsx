                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="hidden md:flex">
                        <ul className="hidden md:flex">
                            <li className="text-lg font-bold  pr-8"><Link href="/Courses" className="transition duration-300 focus:outline-none focus:underline hover:underline">Courses</Link></li>
                            <li className="text-lg font-bold  pr-8"><Link href="/About" className="transition duration-300 focus:outline-none focus:underline hover:underline">About us</Link></li>
                            <li className="text-lg font-bold  pr-8"><Link href="/Study_Material" className="transition duration-300 focus:outline-none focus:underline hover:underline">Study Material</Link></li>
                            <li className="text-lg font-bold  pr-8"><Link href="/Careers" className="transition duration-300 focus:outline-none focus:underline hover:underline">Test Series</Link></li>
                            ...
                            <li className="text-lg font-bold  pr-8"><Link href="/" className="transition duration-300 focus:outline-none focus:underline hover:underline">More</Link></li>
                        </ul>
                    </div>
